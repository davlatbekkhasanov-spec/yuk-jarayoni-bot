...
from services.load_service import push_live_session_hub, refresh_group_status, session_hub_metadata
...
async def on_join(callback: CallbackQuery, callback_data: JoinCb, bot: Bot) -> None:
    ...
    push_session_start_background(
        ...
        user_name=name,
        activity_type="yuk",
        metadata=session_hub_metadata(callback_data.session_id),
    )
